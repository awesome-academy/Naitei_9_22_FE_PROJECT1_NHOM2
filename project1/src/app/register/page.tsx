...
export default function Register() {
    ...
    const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            if (!website.trim()) {
                validationErrors.push("Vui lòng nhập website");
            }
            ...
            if (!confirmPassword) {
                validationErrors.push("Vui lòng nhập lại mật khẩu");
                ...
                <form onSubmit={handleSubmit}>
                    <div className="flex flex-col space-y-16">
                        ...
                        <div>
                            ...
                            {errors.length > 0 && (
                                <div className="text-red-600 text-sm text-center bg-red-100 p-2 rounded mt-8">
                                    {errors.join("\n")}
                                </div>
                            )}
                            ...
                            <div className="flex space-x-4 mt-8">
                                <Button
                                    ...
                                    size="default"
                                    className="bg-emerald-500 text-white hover:bg-emerald-600 focus:ring-emerald-500 focus:ring-offset-emerald-500 rounded-3xl focus:outline-none focus:ring-2 disabled:opacity-50 disabled:cursor-not-allowed transition duration-200 w-auto"
                                >
                                    QUAY LẠI
                                </Button>
